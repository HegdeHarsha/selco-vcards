document.addEventListener('DOMContentLoaded', () => {
    ...
    if (employeeId) {
        // --- Visitor View ---
        // 'employeeData' is a global variable from the employees-data.js file
    ...
    function generateQRCode(event) {
        ...
        new EasyQRCodeJS(qrContainer, { text: link, width: 128, height: 128 });
        qrContainer.innerHTML += `<div class="share-link">Share Link: <input type="text" value="${link}" readonly onclick="this.select()"></div>`;
    }
    
    function renderVCard(emp) {
        // Find employee index to create the correct link for the vCard
        const empId = employeeData.findIndex(e => e.Name === emp.Name && e['Email Id'] === emp['Email Id']) + 1;
